    ...
    inner class Success {
        ...
        fun `담당학생 목록과 문서를 함께 조회한다`() {
            ...
            assertAll(
                ...
                { assertEquals(Platform.LMS, studentResponse.platform) },
                { assertEquals(1L, studentResponse.organizationId) },
                { assertEquals("테스트학원", studentResponse.organizationName) },
