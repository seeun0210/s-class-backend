...
import com.sclass.backoffice.coinpackage.dto.ChangeCoinPackageStatusRequest
...
import com.sclass.backoffice.coinpackage.usecase.ChangeCoinPackageStatusUseCase
...
class CoinPackageController(
    ...
    private val changeCoinPackageStatusUseCase: ChangeCoinPackageStatusUseCase,
) {
    @GetMapping
    ...
    fun changeStatus(
        ...
        @RequestBody @Valid request: ChangeCoinPackageStatusRequest,
    ): ApiResponse<Unit> {
        changeCoinPackageStatusUseCase.execute(id, request.status)
